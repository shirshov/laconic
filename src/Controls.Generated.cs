...
namespace Laconic
{
    ...
    public partial class Button : View<xf.Button>
    {
        ...
        {
            set => SetEvent(nameof(Clicked), value, (ctl, handler) => ctl.Clicked += handler,
                (ctl, handler) => ctl.Clicked -= handler);
        }

        public Expression<Func<Signal>> Pressed
        {
            set => SetEvent(nameof(Pressed), value, (ctl, handler) => ctl.Pressed += handler,
                (ctl, handler) => ctl.Pressed -= handler);
        }

        public Expression<Func<Signal>> Released
        {
            set => SetEvent(nameof(Released), value, (ctl, handler) => ctl.Released += handler,
                (ctl, handler) => ctl.Released -= handler);
        }
    }
    ...
    public partial class Editor : View<xf.Editor>
    {
        ...
        {
            set => SetEvent(nameof(Completed), value, (ctl, handler) => ctl.Completed += handler,
                (ctl, handler) => ctl.Completed -= handler);
        }
    }
    ...
    public partial class Page<T>
    {
        ...
        {
            set => SetEvent(nameof(Appearing), value, (ctl, handler) => ctl.Appearing += handler,
                (ctl, handler) => ctl.Appearing -= handler);
        }

        public Expression<Func<Signal>> Disappearing
        {
            set => SetEvent(nameof(Disappearing), value, (ctl, handler) => ctl.Disappearing += handler,
                (ctl, handler) => ctl.Disappearing -= handler);
        }

        public Expression<Func<Signal>> LayoutChanged
        {
            set => SetEvent(nameof(LayoutChanged), value, (ctl, handler) => ctl.LayoutChanged += handler,
                (ctl, handler) => ctl.LayoutChanged -= handler);
        }
    }
    ...
    public partial class Picker : View<xf.Picker>
    {
        ...
        {
            get => GetValue<IList>(xf.Picker.ItemsSourceProperty);
        ...
        public Expression<Func<Signal>> SelectedIndexChanged
        {
            set => SetEvent(nameof(SelectedIndexChanged), value, (ctl, handler) => ctl.SelectedIndexChanged += handler,
                (ctl, handler) => ctl.SelectedIndexChanged -= handler);
        }
    }
    ...
    public partial class SearchBar : View<xf.SearchBar>
    {
        ...
        {
            set => SetEvent(nameof(SearchButtonPressed), value, (ctl, handler) => ctl.SearchButtonPressed += handler,
                (ctl, handler) => ctl.SearchButtonPressed -= handler);
        }
    }
    ...
    public partial class Slider : View<xf.Slider>
    {
        ...
        {
            set => SetEvent(nameof(DragCompleted), value, (ctl, handler) => ctl.DragCompleted += handler,
                (ctl, handler) => ctl.DragCompleted -= handler);
        }

        public Expression<Func<Signal>> DragStarted
        {
            set => SetEvent(nameof(DragStarted), value, (ctl, handler) => ctl.DragStarted += handler,
                (ctl, handler) => ctl.DragStarted -= handler);
        }
    }
