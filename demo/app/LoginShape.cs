...
{
    public class LoginShape : xf.ContentPage
    {
        protected override void OnAppearing()
        {
            BackgroundColor = xf.Color.FromHex("#222222");
            ...
            Content = binder.CreateView(s => new Grid {
                ...
                ["photo", column: 1] =
                    new Image {
                        ...
                        WidthRequest = 150,
                        HeightRequest = 150,
                        Margin = new xf.Thickness(0, 0, 0, 8),
                        Source =
                        ...
                        Clip = new EllipseGeometry {Center = new xf.Point(75, 75), RadiusX = 75, RadiusY = 75}
                    },
                ["controls", row: 1, column: 1] = new Grid {
                    ...
                    ["outline", rowSpan: 7, columnSpan: 4] = new Path {
                        HorizontalOptions = xf.LayoutOptions.Fill,
                    ...
                    ["title", row: 1, column: 1] =
                        new Label {
                            Text = "LOGIN",
                            TextColor = xf.Color.FromHex("#222222"),
                            FontFamily = "DINBold",
                            FontSize = 22,
                    ...
                    ["usernameLabel", row: 2, column: 1, columnSpan: 2] =
                        new Label {Text = "Username", TextColor = xf.Color.FromHex("#222222"), FontSize = 16},
                    ["username", row: 3, column: 1, columnSpan: 2] =
                        new Entry {
                            Placeholder = "Enter username",
                            Text = "daortin@microsoft.com",
                            TextColor = xf.Color.FromHex("#222222"),
                            BackgroundColor = xf.Color.FromHex("#D8D8D8")
                        },
                    ["passwordLabel", row: 4, column: 1, columnSpan: 2] =
                        new Label {
                            Margin = new xf.Thickness(0, 4, 0, 0),
                            Text = "Password",
                            TextColor = xf.Color.FromHex("#222222"),
                            FontSize = 16
                        },
                    ...
                    ["foo", row: 6, column: 1, columnSpan: 2] = new Grid {
                        ...
                        HorizontalOptions = xf.LayoutOptions.Center,
                        VerticalOptions = xf.LayoutOptions.End,
                        Margin = new xf.Thickness(0, 0, 0, 13),
                        ["ellipse"] =
                            new Ellipse {Fill = xf.Color.FromHex("#222222"), WidthRequest = 64, HeightRequest = 64},
                        ["arrow"] = new Path {
                            Data =
